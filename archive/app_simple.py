...
"""
    ...
    actions = [
        cl.Action(name="check_homework", payload={"action": "check"}, label="📸 检查作业"),
        cl.Action(name="create_planner", payload={"action": "planner"}, label="📅 整理清单"),
        cl.Action(name="view_mistakes", payload={"action": "mistakes"}, label="📕 复习错题"),
    ]
